<%@page import="com.mgr.netflix.contents.vo.WishAndLikeVO"%>
<%@page import="com.mgr.netflix.contents.service.WishLikeService"%>
      ...
      <div class="popular_movie_info_box">
         <div class="popular_movie_info">
            <div class="popular_movie_title">
               <img
                  src="http://kghosting.dothome.co.kr/logo/doctor_lifes_logo.png"
                  alt="">
            </div>
            <div class="popular_movie_overview">어떤 이에겐 아픔이 어떤 이에겐 희망이 되는
               병원이란 공간. 산모는 아기를 지켜내겠다는 간절함으로 하루하루를 버텨낸다. 이 모습을 지켜보는 석형도 계속 마음이
               쓰이는데... 한편 서울과 속초를 오가며 바쁘게 일하는 송화에게 한 가지 제안이 건네진다.</div>
         </div>
      ...
      <div class="slider-container">
         <c:forEach var="i" items="${contentsList}">
            <div class="slide"
            			...
            			data-row_num="${profileInfo.row_num }" 
...
<div class="slider-frame">
      ...
      <!--여기 items에서 가져오는 값 빼 다른거 건드시면 안됩니다!!!!!  -->
         ...
         <c:if test="${i.content_id == w.content_id}">
      ...
      <div class="contents_layer">
         <div class="layer_moviebox">
            ...
            <div class="layer_inner_info">
               <img id="logo_link"src="http://kghosting.dothome.co.kr/logo/exit_logo.png" alt="">
               <div class="layer_info_btn">
                  <ul>
                     <li><i class="fas fa-play"><a id="play_btn" href="http://kghosting.dothome.co.kr/video/exit.mp4">재생</a></i></li>
