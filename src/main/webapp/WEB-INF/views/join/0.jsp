...
<body>
	<div id="appMountPoint">
		<div class="netflix-sans-font-loaded">
			<div
				class="basicLayout notMobile modernInApp hasExtendedDiacritics signupSimplicity-passwordOnly simplicity"
				lang="ko-KR" dir="ltr">
				...
				<div class="simpleContainer" data-transitioned-child="true">
					<div class="centerContainer firstLoad"
						...
						<form method="POST" action ="join/step0.do">
							<div class="regFormContainer passwordFormContainer"
								...
								<div class="stepHeader-container" data-uia="header">
									<div class="stepHeader" data-a11y-focus="true">
										...
										<h1 class="stepTitle" data-uia="stepTitle">
											<span id="" data-uia="">회원님, 반갑습니다. <br> 넷플릭스 가입
												절차는 간단합니다.
											</span>
										</h1>
									</div>
								</div>
								<div class="contextRow" data-uia="subtitle">비밀번호를 입력하시면 바로
									시청하실 수 있습니다.</div>
								<div>
									<ul class="simpleForm structural ui-grid">
										<li data-uia="field-email+wrapper" class="nfFormSpace"><div
												class="input-readOnly">
												<div class="label-readOnly">이메일 주소</div>
												<div class="value-readOnly" data-uia="field-email"
													id="field-email">${joinEmail }</div>
											</div></li>
										<li data-uia="field-password+wrapper" class="nfFormSpace"><div
												data-uia="field-password+container"
												class="nfInput nfInputOversize">
												<div class="nfInputPlacement">
													<label class="input_id" placeholder="password"><input
														type="password" data-uia="field-password" name="password"
														class="nfTextField" id="id_password" value="" tabindex="0"
														autocomplete="new-password" maxlength="61" minlength="4"
														dir=""><label for="id_password" class="placeLabel">비밀번호를
															입력하세요</label></label>
												</div>
											</div></li>
									</ul>
								</div>
								<a class="link-forgot-password" href="/LoginHelp">비밀번호를
									잊으셨나요?</a>
								<div class="submitBtnContainer">
									<button type="submit" autocomplete="off"
										class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize"
										data-uia="cta-registration" placeholder="regForm_button_next">다음</button>
								</div>
							</div>
						</form>
					</div>
