						...
						<div class="regContainer" data-uia="context-registration">
							...
							<div class="stepHeader-container" data-uia="header">
								...
								<div class="stepHeader" data-a11y-focus="true">
									...
									<h1 class="stepTitle" data-uia="stepTitle">계정 설정 마무리하기</h1>
								</div>
							</div>
							<div id="" class="contextBody contextRow"
								data-uia="regContextBody">맞춤형 콘텐츠 서비스, 가자플릭스! 비밀번호를 설정해
								다양한 디바이스에서 아무 때나 시청하세요.</div>
						</div>
						<div class="submitBtnContainer">
							<button type="button" onclick="location='step2.do'"
								autocomplete="off"
								class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize"
								data-uia="cta-continue-registration"
								placeholder="registration_button_continue">다음</button>
						</div>
					</div>
				</div>
