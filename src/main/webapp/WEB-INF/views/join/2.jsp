			...
			<div
				...
				<div class="simpleContainer" data-transitioned-child="true">
					...
					<div class="centerContainer"
						...
						<form:form action="step3.do" method="post" commandName="formData">
							<div class="regFormContainer" data-uia="form-registration">
								<div class="stepHeader-container" data-uia="header">
									...
									<div class="stepHeader" data-a11y-focus="true" tabindex="0">
										...
										<h1 class="stepTitle" data-uia="stepTitle">비밀번호를 설정해 멤버십을
											시작하세요.</h1>
									</div>
								</div>
								<div>

									<div class="contextRow" data-uia="contextRowDone">몇 단계만 더
										거치면 넷플릭스 가입 완료!</div>

									<div class="contextRow" data-uia="contextRowPaperWork">복잡한
										단계는 모두 없앴습니다.</div>
									<ul class="simpleForm structural ui-grid">

										<li data-uia="field-email+wrapper" class="nfFormSpace"><div
												data-uia="field-email+container"
												class="nfInput nfInputOversize">

												<div class="nfInputPlacement">
													<label class="input_id" placeholder="email">
													<form:input path ="email" data-uia="field-email" value="${joinEmail}"
														   class="nfTextField hasText" id="id_email" type="email"
														   tabindex="0" autocomplete="off" maxlength="50"
														   minlength="5" dir="ltr"/>
										...
										<li data-uia="field-password+wrapper" class="nfFormSpace">
											...
											<div data-uia="field-password+container"
												class="nfInput nfInputOversize">
												<div class="nfInputPlacement">
													<label class="input_id" placeholder="password">
													<form:input path="password" data-uia="field-password" 
														   class="nfTextField" id="id_password" type="password"
														   tabindex="0" autocomplete="new-password" maxlength="62"
														   minlength="6" dir=""/>
													<label for="id_password" class="placeLabel">비밀번호를 추가하세요</label></label>
												</div>
											</div>
										</li>
										<li data-uia="field-pipcConsent+wrapper" class="nfFormSpace"><div
												class="ui-binary-input">

												<input type="checkbox" class="" name="pipcConsent"
													id="cb_pipcConsent" tabindex="0"
													data-uia="field-pipcConsent" value="true"><label
													for="cb_pipcConsent" data-uia="field-pipcConsent+label">

													<span id="" data-uia="">예, 저는 <a
														href="https://help.netflix.com/legal/privacy"
														target="_blank">개인정보 처리방침</a>에 따른 개인정보 수집 및 활용에 동의합니다.
												</span>
												</label>

												<div class="helper"></div>
											</div></li>
										<li data-uia="field-emailPreference+wrapper"
											class="nfFormSpace">

											<div class="ui-binary-input">
												<input type="checkbox" class="" name="emailPreference"
													id="cb_emailPreference" tabindex="0"
													data-uia="field-emailPreference" value="true"> <label
													for="cb_emailPreference"
													data-uia="field-emailPreference+label">예, 넷플릭스 특별
													할인 알림 이메일을 보내주세요. (선택 사항)</label>
												<div class="helper"></div>
											</div>
										</li>
									</ul>
							...
							<div class="submitBtnContainer">
								<!-- onclick="location='<c:url value="step3.do"/>'" -->
								<button type="submit"							 
									autocomplete="off"
									class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize"
									data-uia="cta-registration"
									placeholder="regForm_agree_next_registration_button">동의하고
									다음</button>
							</div>
						</form:form>
					</div>
